    ...
    >
      ...
      <div className="relative rounded-2xl border bg-surface/50 backdrop-blur-2xl p-1 shadow-premium-dark dark:shadow-premium-dark overflow-hidden">
        <div className="h-10 border-b flex items-center px-6 justify-between bg-surface/80">
          <div className="text-xs font-mono text-muted-foreground uppercase tracking-widest">Master Service Agreement — Acme Corp</div>
          ...
          <div className="col-span-2 space-y-8 text-foreground/80 font-serif text-lg leading-relaxed">
            ...
            <div className="relative">
              ...
              <p className="relative z-10 pl-4 border-l-2 border-transparent">
                (a) any breach of this Agreement by Provider; (b) any negligence or willful misconduct of Provider; or (c) any claim that the Services or Deliverables infringe upon any intellectual property rights of a third party.
              </p>
            </div>
            <p>
              4.2 <strong className="text-foreground">Limitation of Liability.</strong> In no event shall either party be liable for any indirect, incidental, special, consequential, or punitive damages, or for any loss of profits or revenues, whether incurred directly or indirectly.
            </p>
          </div>
          ...
          <div className="col-span-1 border-l pl-8 space-y-6">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-semibold uppercase tracking-wider text-destructive">Critical Risk Detected</span>
              </div>
              <h4 className="font-medium text-sm mb-2">Uncapped IP Indemnification</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Section 4.1(c) exposes the provider to uncapped liability for third-party intellectual property claims. Standard practice is to cap this liability or require the client to notify within 30 days.
              </p>
              <div className="mt-4 pt-4 border-t flex justify-between items-center">
                <span className="text-[10px] text-muted-foreground font-mono">CONFIDENCE: 98%</span>
                <span className="text-xs font-medium cursor-pointer hover:text-foreground transition-colors">View Playbook</span>
              </div>
            </motion.div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-background flex flex-col overflow-hidden selection:bg-foreground selection:text-background">
      ...
      <header className="fixed top-0 w-full z-50 border-b bg-background/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Button render={<Link href="/dashboard" />} className="rounded-xl px-6 bg-foreground text-background hover:bg-foreground/90 transition-all">
              Access Platform
            </Button>
          </div>
        </div>
      ...
      <main className="flex-1 pt-40 pb-32">
        ...
        <section className="px-6 max-w-7xl mx-auto relative z-10">
          ...
          >
            <motion.h1 variants={fadeUp} className="font-serif text-5xl md:text-7xl font-medium tracking-tight text-balance mb-8 text-foreground leading-[1.1]">
              Contract analysis, <br className="hidden md:block" /> elevated.
            </motion.h1>
            <motion.p variants={fadeUp} className="text-lg md:text-xl text-muted-foreground max-w-2xl text-balance mb-12 font-light">
            ...
            <motion.div variants={fadeUp} className="flex gap-4">
              <Button render={<Link href="/dashboard" />} size="lg" className="rounded-xl px-8 h-14 text-base bg-foreground text-background hover:bg-foreground/90 hover:scale-[1.02] transition-all duration-300">
                Begin Trial
              </Button>
            </motion.div>
          </motion.div>
        ...
        <section className="py-40 px-6 max-w-7xl mx-auto mt-20">
          <div className="mb-24 md:flex justify-between items-end border-b pb-8">
            <h2 className="font-serif text-4xl md:text-5xl text-foreground">Capabilities</h2>
            <p className="text-muted-foreground max-w-md mt-6 md:mt-0 text-sm">
              A meticulously engineered pipeline for legal operations. Every feature is designed with intention and executed with precision.
            </p>
          </div>
