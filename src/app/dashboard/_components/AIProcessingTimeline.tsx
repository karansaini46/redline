...
import { UploadCloud, FileText, BrainCircuit, CheckCircle2 } from "lucide-react";
    ...
    <div className="w-full relative py-4">
      ...
      <StaggerContainer className="relative flex justify-between w-full">
        {STAGES.map((stage, i) => {
          ...
          return (
            <StaggerItem key={stage.id} className="flex flex-col items-center gap-3 relative z-10">
              <motion.div 
                ...
                animate={isActive ? { scale: [1, 1.1, 1], boxShadow: ["0 0 0 0 rgba(var(--primary), 0)", "0 0 0 8px rgba(var(--primary), 0.2)", "0 0 0 0 rgba(var(--primary), 0)"] } : {}}
              ...
              <div className="text-center">
                ...
                {isActive && (
                  <FadeIn delay={0.5}>
                    <p className="text-xs text-primary animate-pulse mt-0.5">Processing...</p>
                  </FadeIn>
                )}
              </div>
            </StaggerItem>
