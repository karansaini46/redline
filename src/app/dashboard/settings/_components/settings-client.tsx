  ...
  const handleSave = async () => {
    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent("avatarChanged", { detail: selectedAvatar }),
      );
        ...
        <StaggerItem>
          <div className="rounded-xl border border-border/50 bg-surface shadow-sm flex flex-col hover:border-foreground/20 transition-colors overflow-hidden">
            <div className="flex items-center gap-2 p-6 border-b border-border/50 bg-muted/20">
              ...
              <h3 className="text-sm font-medium font-serif tracking-tight">
                Personal Profile
              </h3>
            </div>
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="rounded-xl bg-background border-border/50 focus-visible:ring-1 focus-visible:border-foreground"
                />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-medium text-foreground uppercase tracking-wider">
            ...
            <div className="px-6 pb-6 pt-2">
              <div className="border-t border-border/50 pt-6">
                <label className="text-xs font-medium text-foreground uppercase tracking-wider block mb-4">
                  Profile Avatar
                </label>
            ...
            <div className="p-6 grid grid-cols-1 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="rounded-xl bg-background border-border/50 focus-visible:ring-1 focus-visible:border-foreground max-w-md"
                />
              ...
              <div className="flex items-center justify-between p-4 border border-border/50 bg-background rounded-xl">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-medium px-2 py-0.5 bg-primary/10 text-primary uppercase tracking-widest border border-primary/20 rounded-full">
                      Active
                    </span>
                  </div>
                  <p className="text-xs text-muted-foreground font-light">
                    Unlimited AI extractions and team members.
                  </p>
                </div>
                <Button
                  variant="outline"
                  size="sm"
                  className="rounded-xl border-border shadow-none bg-transparent hover:bg-muted/50"
                >
                  Manage Billing
                </Button>
              </div>
        ...
        <StaggerItem>
          <div className="rounded-xl border border-destructive/30 bg-destructive/5 shadow-sm flex flex-col transition-colors overflow-hidden">
            <div className="flex items-center gap-2 p-6 border-b border-destructive/20 bg-destructive/10">
              ...
              <h3 className="text-sm font-medium font-serif tracking-tight text-destructive">
                Danger Zone
              </h3>
            </div>
            <div className="p-6 flex items-center justify-between">
              ...
              <Button
                variant="destructive"
                size="sm"
                className="rounded-xl shadow-none bg-destructive hover:bg-destructive/90 text-destructive-foreground"
              >
                Delete Organization
              </Button>
            </div>
