...
export default async function InvitePage({ params }: { params: { token: string } }) {
    ...
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="text-center p-8 border rounded shadow">
          ...
          <p className="mb-4">Please log in or sign up to accept this invitation.</p>
  ...
  return (
    <div className="flex h-screen items-center justify-center">
      <form action={handleAccept} className="text-center border p-8 rounded shadow max-w-sm">
